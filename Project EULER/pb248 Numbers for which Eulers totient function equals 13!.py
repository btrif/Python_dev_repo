...
#The  Euler Project  https://projecteuler.net/problem=248
'''
...
# Fun problem! This problem was a breeze for me because I already had code for the inversed phi function.
# It is slow, but generic.
