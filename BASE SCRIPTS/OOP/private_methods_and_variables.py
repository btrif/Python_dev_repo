...
# A way to list all the private, superprivate attributes
print(' mc.__dict__  :       ',mc.__dict__)

# print(mc.__superprivate)      #   Does not work !

##  Special access to the superprive variable is done as follows :
print('Special access to the superprive variable :   ',mc._MyClass__superprivate)
...
.__variable          is often incorrectly considered superprivate, while it's actual meaning is just to name mangle to prevent accidental access[1]
                            It can't be called outside the class
