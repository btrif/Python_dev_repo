#  Created by Bogdan Trif on 19-07-2018 , 6:45 PM.
...
You will notice that we haven't implemented the do_something method, even though we are required to implement it, 
because this method is decorated as an abstract method with the decorator "abstractmethod". 
...
x = DoAdd42(10)
y = DoMul42(10)
print('x : ', x.do_something())
print('y :',y.do_something())
...
This makes it possible to provide some basic functionality in the abstract method, 
which can be enriched by the subclass implementation.
'''
print()
from abc import ABC, abstractmethod
