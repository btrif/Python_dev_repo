...
print('--------     Generate primes with a double for nested loop, Only as an example    ---------------------')
...
# Inverse for loop, FOR loop going backwards:
print('\n#### going backwards with step 2 ')
print('Hello!')
for i in range(10,0,-2):
    print(i, end=' ')
print('\n')

print('#### going backwards with step 1 ')
for i in range(13,-1,-1):
    print (i, end= ' ')
print('\n#### using reversed range')
for x in reversed(range(190,200)) :
    print(x, end=' ' )


print('\n\n==============   EXAMPLES of FOR LOOP with multiple variables  ==============')
